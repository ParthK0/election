    ...
    items: [
      {
        ...
        desc: "Official election authority — schedules, results, and voter registration.",
      },
      {
        name: "Voter Service Portal",
        url: "https://voters.eci.gov.in",
        desc: "Check voter registration, download e-EPIC, and find polling stations.",
      },
      {
        name: "Know Your Candidate",
        url: "https://affidavit.eci.gov.in",
        desc: "View candidate affidavits — criminal records, assets, and education.",
      },
      {
        name: "cVIGIL App",
        url: "https://cvigil.eci.gov.in",
        desc: "Report Model Code of Conduct violations with photo/video evidence.",
      },
      {
        name: "ECI Results Portal",
        url: "https://results.eci.gov.in",
        desc: "Live and historical election results, constituency-wise.",
      },
      {
        name: "Constitution of India",
        url: "https://legislative.gov.in/constitution-of-india",
        desc: "Full text of the Constitution including electoral provisions (Articles 324-329).",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Vote.gov",
        url: "https://vote.gov",
        desc: "Official U.S. government resource for voter registration and state-specific information.",
      },
      {
        name: "USA.gov — Voting",
        url: "https://www.usa.gov/register-to-vote",
        desc: "Federal guide to registering, finding polling places, and understanding your ballot.",
      },
      {
        name: "Ballotpedia",
        url: "https://ballotpedia.org",
        desc: "Non-partisan encyclopedia of American politics — candidates, ballot measures, and election data.",
      },
      {
        name: "Federal Election Commission (FEC)",
        url: "https://www.fec.gov",
        desc: "Campaign finance data, contribution limits, and political committee filings.",
      },
      {
        name: "National Archives — Electoral College",
        url: "https://www.archives.gov/electoral-college",
        desc: "Official Electoral College information, historical results, and constitutional provisions.",
      },
      {
        name: "National Association of Secretaries of State",
        url: "https://www.nass.org/can-i-vote",
        desc: "State-by-state voting rules, ID requirements, and absentee ballot information.",
      },
    ],
  },
];
    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      <header className="mb-12">
        ...
        <p className="text-text-muted text-lg max-w-2xl leading-relaxed">
          Every fact in ElectIQ is sourced from official government election
          commissions and non-partisan organizations. We link directly so you
          can verify.
        </p>
      </header>
      ...
      <div className="flex items-center gap-3 p-4 bg-accent-green/5 border border-accent-green/10 rounded-2xl mb-12">
        ...
        <p className="text-sm text-accent-green/90 font-medium">
          ElectIQ never expresses political opinions or recommends candidates.
          All data is factual and sourced from official bodies.
        </p>
      </div>
