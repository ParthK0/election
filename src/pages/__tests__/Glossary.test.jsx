...
describe('Glossary Page', () => {
  const mockData = {
    glossary: [
      { term: 'Ballot', definition: 'A process of voting.', category: 'Voting' },
      { term: 'Candidate', definition: 'A person who applies for a job or is nominated for election.', category: 'People' },
      { term: 'Electorate', definition: 'All the people in a country or area who are entitled to vote.', category: 'People' }
    ]
  };
